...
public class MainWindow extends UiPart<Stage> {
    ...
    private PersonListV2 personListV2;
     ...
     */
    void fillInnerParts() {
        personListV2 = new PersonListV2(logic.getFilteredPersonList());
        personListPanelPlaceholder.getChildren().add(personListV2.getRoot());
    ...
    public PersonListV2 getPersonListPanel() {
        return personListV2;
    }
